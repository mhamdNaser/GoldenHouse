<div class="navbar navbar-expand-lg mypseconbg navbar-dark fixed-top py-1 w-100">
    <div class="container p-2">
        <a class="logo navbar-brand d-flex align-items-center"><img src="{{ url('/images/login.jpg') }}" alt=""
                width="90px">Golden House</a>
                ...
                @if (Route::has('login'))
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link d-flex align-items-center" href="#" role="button"
                                    ...
                                    <span style="font-size: 12px">
                                        {{ strtoupper(Auth::user()->user_first_name) }}
                                        {{ strtoupper(Auth::user()->user_last_name) }}&emsp;
                                    </span>
                                    <i class="fa fa-user-circle-o fs-4"></i>
                                </a>
                                <ul class="dropdown-menu me-5 mt-2">
                                    <li><a class="dropdown-item" href="{{ asset('blog') }}">Blog</a></li>
                                    <li><a class="dropdown-item" href="{{ asset('profile') }}">Dashboard</a></li>
                                    <hr>
                    ...
                    @else
                        <li class="nav-item me-2">
                            <a class="nav-link" href="{{ asset('login') }}" title="Login">Login<i
                                    class="fa fa-sign-out ms-2"></i></a>
                        </li>
                        <li class="nav-item me-2">
                            <a class="nav-link" href="{{ asset('register') }}" title="register">Register<i
                                    class="fa fa-cogs ms-2"></i></a>
                        </li>
                    @endif
                    @endif
