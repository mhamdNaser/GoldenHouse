...
<form class="mt-4" method="post" action="{{route('category.update', $category->id)}}" enctype="multipart/form-data">
    ...
    <div class="row align-items-center mb-2">
        <div class="form-outline">
            ...
            <textarea class="form-control" type="text" id="Category_Description" rows="4" name="Category_Description" required placeholder="Category Description" >{{$category->Category_Description}}</textarea>
        </div>
    </div>
