...
<form class="mt-4" method="post" action="{{route('DeliveryService.store')}}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row justify-content-center align-items-center mb-2">
        <div class="form-outline mb-4">
            ...
            <input class="form-control" type="text" id="lname" name="service_desc" required placeholder="Service Description">
        </div>
    </div>
    <div class="row justify-content-center align-items-center mb-2">
        <div class="form-outline mb-4">
