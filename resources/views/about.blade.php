...
<div class="row pt-5 pb-5 myboxshadow"
    ...
    <div class="col-lg-12 pt-5 pb-5 mt-5 mb-5 myopacity0 rounded-3">
        ...
        <div class="row justify-content-around align-items-center text-dark myopacity0 rounded-3 bg-light mt-5">
            ...
            <div class="col-lg-6">
                <img class="w-100 rounded-end" src="{{ url('/images/about2.jpg') }}" alt=""><br>
            </div>
        </div>
    </div>
</div>
