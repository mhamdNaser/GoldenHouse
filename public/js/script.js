...
let regPass1    = "^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[@$!%*?&])([a-zA-Z0-9@$!%*?&]{8,12}$)"
...
checkemail = () => {
    if (mail.value.match(regmail)){
        ...
        document.getElementById("mailerror").innerHTML = "Your E-mail Not Correct"
    }
}
...
checkphone = () => {
    if (phone.value.match(regphone)){
        ...
        document.getElementById("phonerror").innerHTML = "Only 10 Number Please"
    }
}
